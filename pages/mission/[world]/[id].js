...
export default function MissionPage() {
  ...
  if (!mission)
    return (
      <div className="h-screen w-screen flex items-center justify-center bg-black text-red-400">
  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-b from-black via-[#050510] to-[#0a0a0f] text-green-300 p-10 overflow-y-auto">
      ...
      <div className="flex justify-end mt-10">
        <button
          onClick={() => router.push(`/mission/${world}/${parseInt(id) + 1}`)}
